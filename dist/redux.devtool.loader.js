...
var jsondiffpatch_umd_default = /*#__PURE__*/__webpack_require__.n(jsondiffpatch_umd);
...
var setConfig = function setConfig(keys, value) {
  var chain = [].concat(keys);
  var lastKey = chain.pop();
  get.get.apply(void 0, [DevToolConfigs].concat(_toConsumableArray(chain.concat(function (x) {
    return x[lastKey] = value;
  }))));
  localStorage.setItem(localStorageConfigId, JSON.stringify(DevToolConfigs));
};
  ...
  return {
    ...
    actionListener: function actionListener(_ref) {
      ...
      actionLog.push({
        ...
        payload: payload,
        delta: type === (external_Redux_default()).TYPES.ACTION ? jsondiffpatch_umd_default().diff(prevStore, store) : undefined
      });
    ...
    startReduxDevTool: function startReduxDevTool() {
      ...
      devToolWindow.jsondiffpatch = (jsondiffpatch_umd_default());
