...
var Redux = /*#__PURE__*/function () {
  ...
  _createClass(Redux, null, [{
    ...
    value: function init() {
      ...
      _classPrivateFieldSet(_classStaticPrivateMethodGet(Redux, Redux, _getInstance).call(Redux), _store, produce(_classPrivateFieldGet(_classStaticPrivateMethodGet(Redux, Redux, _getInstance).call(Redux), _store), function (draft) {
    ...
    */
    ...
    value: function createAction(reduxId, func) {
      ...
      var rawAction = function rawAction(payload) {
        ...
        //get new store
        var newStore = produce(_classPrivateFieldGet(_classStaticPrivateMethodGet(Redux, Redux, _getInstance).call(Redux), _store), function (draft) {
          return func(draft, payload);
        });

        _classPrivateFieldSet(_classStaticPrivateMethodGet(Redux, Redux, _getInstance).call(Redux), _store, newStore); //send new action log to listeners
